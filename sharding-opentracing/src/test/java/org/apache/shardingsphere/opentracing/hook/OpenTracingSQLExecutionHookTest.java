...
public final class OpenTracingSQLExecutionHookTest extends BaseOpenTracingHookTest {
    ...
    private Scope mockActiveSpan() {
        Scope result = mock(Scope.class);
        ExecutorDataMap.getValue().put(OpenTracingRootInvokeHook.ACTIVE_SPAN_CONTINUATION, result);
        return result;
    }
    ...
    public void assertExecuteSuccessForTrunkThread() {
        ...
        verify(activeSpan, times(0)).close();
